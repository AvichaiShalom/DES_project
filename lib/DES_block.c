...
// Initial Permutation (IP) table - מבצעת שחלוף ראשוני של הקלט
int IP[] = {
...
// Final Permutation (FP) table - מבצעת שחלוף סופי אחרי 16 השלבים
int FP[] = {
...
// Expansion table (E) - מרחיבה את חצי הבלוק הימני מ-32 ביט ל-48 ביט
int E[] = {
    32, 1, 2, 3, 4, 5, 4, 5,
    6, 7, 8, 9, 8, 9, 10, 11,
...
// Key schedule tables (PC-1 and PC-2) - משמשות ליצירת מפתחות סיבוב
// Permuted Choice 1 (PC-1) table - בוחרת 56 ביט מתוך המפתח המקורי
int PC1[] = {
    57, 49, 41, 33, 25, 17, 9,
    1, 58, 50, 42, 34, 26, 18,
    10, 2, 59, 51, 43, 35, 27,
...
// Permuted Choice 2 (PC-2) table - בוחרת 48 ביט ליצירת מפתח סיבוב
int PC2[] = {
    14, 17, 11, 24, 1, 5,
    3, 28, 15, 6, 21, 10,
    23, 19, 12, 4, 26, 8,
...
// מספר הביטים לסיבובים שמאלה (shifts) עבור יצירת המפתחות בכל שלב
